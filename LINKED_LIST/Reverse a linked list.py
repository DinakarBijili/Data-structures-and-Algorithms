...
#         prev = None
#         current = head # here current is head 
        
#         while (current != None):
#             next = current.next  # next is current.next 
#             current.next = prev # here next becomes prev
#             prev, current = current , prev # swap 
#             current = next # moving current value to next 
#         head = prev
#         return head
